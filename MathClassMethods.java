...
public class MathClassMethods{
	public static void main(String[] args){
		...
		System.out.printf("The absolute value raise to the power is %f%n",Math.pow(num1,2));
		
		System.out.printf("The absolute value square root is %f%n",Math.sqrt(num1));
		...
		System.out.printf("The random  number is %d%n",Math.random());
