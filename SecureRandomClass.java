...
public class SecureRandomClass {
    public static void main(String[] args){
		...
		int integerWithBound = secureRandom.nextInt(7000);
		...
		long number1 = secureRandom.nextLong(900_000_000_000L);
		System.out.printf("The generated integer is %d%n",number1);
